...
class ClientInfoFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val onBackPressedCallback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                NavHostFragment.findNavController(this@ClientInfoFragment).navigateUp();
            }
        }
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_client_info, container, false)
        recycleList = view.findViewById(R.id.estate_planing_list)
        val btnSchedule : ImageView = view.findViewById(R.id.btn_schedule)
        val adapter1= PreviousListAdapter()
        val linearLayoutManager = LinearLayoutManager(activity)
        recycleList.layoutManager=linearLayoutManager
        recycleList.adapter=adapter1
