...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun showNotification(remoteMessage: RemoteMessage) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notificationChannel.lightColor = R.color.toolbar_color
       ...
       /* val intent = Intent(this, NotificationView::class.java)
        ...
        pendingIntent = PendingIntent.getActivity(this@MyFirebaseMessagingService,
...
*/
        val notificationBuilder = NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
        notificationBuilder.setAutoCancel(true).setDefaults(Notification.DEFAULT_ALL).setWhen(System.currentTimeMillis()).setSmallIcon(
            R.drawable.icon_1)
            .setContentTitle(remoteMessage.notification?.title)
            .setContentText(remoteMessage.notification?.body)
            .setContentInfo("Info").setPriority(NotificationCompat.PRIORITY_HIGH).setContentIntent(pendingIntent)
